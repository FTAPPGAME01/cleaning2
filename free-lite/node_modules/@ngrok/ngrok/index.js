...
switch (platform) {
  case 'android':
    switch (arch) {
      case 'arm64':
        ...
        try {
          if (localFileExisted) {
            nativeBinding = require('@ngrok/ngrok/ngrok.android-arm64.node')
          } else {
      ...
      case 'arm':
        ...
        try {
          if (localFileExisted) {
            nativeBinding = require('@ngrok/ngrok/ngrok.android-arm-eabi.node')
          } else {
  ...
  case 'win32':
    switch (arch) {
      case 'x64':
        ...
        try {
          if (localFileExisted) {
            nativeBinding = require('@ngrok/ngrok/ngrok.win32-x64-msvc.node')
          } else {
      ...
      case 'ia32':
        ...
        try {
          if (localFileExisted) {
            nativeBinding = require('@ngrok/ngrok/ngrok.win32-ia32-msvc.node')
          } else {
      ...
      case 'arm64':
        ...
        try {
          if (localFileExisted) {
            nativeBinding = require('@ngrok/ngrok/ngrok.win32-arm64-msvc.node')
          } else {
  ...
  case 'darwin':
    ...
    try {
      if (localFileExisted) {
        nativeBinding = require('@ngrok/ngrok/ngrok.darwin-universal.node')
      } else {
    ...
    switch (arch) {
      case 'x64':
        ...
        try {
          if (localFileExisted) {
            nativeBinding = require('@ngrok/ngrok/ngrok.darwin-x64.node')
          } else {
      ...
      case 'arm64':
        ...
        try {
          if (localFileExisted) {
            nativeBinding = require('@ngrok/ngrok/ngrok.darwin-arm64.node')
          } else {
  ...
  case 'freebsd':
    ...
    try {
      if (localFileExisted) {
        nativeBinding = require('@ngrok/ngrok/ngrok.freebsd-x64.node')
      } else {
    ...
    switch (arch) {
      case 'x64':
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              nativeBinding = require('@ngrok/ngrok/ngrok.linux-x64-musl.node')
            } else {
          ...
          try {
            if (localFileExisted) {
              nativeBinding = require('@ngrok/ngrok/ngrok.linux-x64-gnu.node')
            } else {
      ...
      case 'arm64':
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              nativeBinding = require('@ngrok/ngrok/ngrok.linux-arm64-musl.node')
            } else {
          ...
          try {
            if (localFileExisted) {
              nativeBinding = require('@ngrok/ngrok/ngrok.linux-arm64-gnu.node')
            } else {
      ...
      case 'arm':
        ...
        try {
          if (localFileExisted) {
            nativeBinding = require('@ngrok/ngrok/ngrok.linux-arm-gnueabihf.node')
          } else {
